...
seq ='1';
data =  ['/mnt/HDD01/rspl-admin/DATASETS/COVID19 Sequential/Output/frac comp/OF/*.mat'];
...
%             RD_OF_RadarConf(fIn,fOut,fName)
        [betabar(i), beta_mean(i),magnitude_func{1,i}] = Frac_Comp_from_PSD(fIn,fps,startingbin,endingbin);
